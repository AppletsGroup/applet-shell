...
const Drawer: React.FC<DrawerProps> = ({ open, onClose, children }) => {
  ...
  return (
    <div className={`fixed inset-y-0 left-0 z-50 w-64  bg-gray-800 shadow-lg transform transition-transform duration-300 ease-in-out ${open ? 'translate-x-0' : '-translate-x-full'}`}>
